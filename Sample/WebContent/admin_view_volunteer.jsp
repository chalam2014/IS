                    ...
                    <center>
                        ...
                        <%                        
                            try {
                                ...
                                PreparedStatement ps = con.prepareStatement("select v_id,v_name,email,v_skil,v_type,n_volunteer,v_add,contact,status from volunteer");
                                ResultSet rs = ps.executeQuery();
                        %>                      
                        <br><br>
                                <table class = "main" border="3" width="1000" height="50">
                                    ...
                                    <tr width="120" height="50">
                                        ...
                                        <td> <a href=<%= "\"Accept_Volunteer.jsp?vid=" + rs.getString(1) + "\""%> > Accept/</a>
                                        <a href=<%= "\"Delete_Volunteer.jsp?vid=" + rs.getString(1) + "\""%> > Reject</a></td>
                                    </tr>
                                    <%}
                                        } catch (Exception e) {
                                            e.printStackTrace();
