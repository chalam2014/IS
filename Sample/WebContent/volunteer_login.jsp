...
<!--            <p>Please enter your email address to subscribe our newsletter</p>-->
        ...
        <div class="cleaner_h30">&nbsp;</div>
                ...
                <div id="content_right">
                    ...
                    <form action="volunteer_login_process.jsp" method="post" id="alform">
                        <center>
                            ...
                            <br><br><br>
                                        <table>
                                             ...
                                             <tr>
                                                <td align="right">Volunteer ID : </td><td> <input type="text" align="left" name="vid"/></td>
                                            </tr>
                                            <tr></tr> <tr></tr> <tr></tr>
                                        ...
                                        <br>
                                        <font size = '4' > New User ? <a href="voluenteer_register.jsp"><u>Register Here</u></a> </font>
