...
<!--            <p>Please enter your email address to subscribe our newsletter</p>-->
        ...
        <div class="cleaner_h30">&nbsp;</div>
                ...
                <div id="content_right">
                    <form action="sponsor_login_process.jsp" method="post" id="alform">
                        <center>
                            <h2>Sponsor Login</h2>
                            <br><br><br>
                                        <table>
                                             ...
                                             <tr>
                                                <td align="right">Sponsor ID : </td><td> <input type="text" align="left" name="sid"/></td>
                                            </tr>
                                            <tr></tr> <tr></tr> <tr></tr>
                                        ...
                                        <br>
                                        <font size = '4'> New User ? <a href="sponsor_register.jsp"><u>Register Here</u></a> </font>
                                        </center>
                                        </form>       
                                        <div class="cleaner">&nbsp;</div>
                                        </div>                    
