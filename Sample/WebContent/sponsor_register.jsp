        ...
        <div class="cleaner_h30">&nbsp;</div>
                ...
                <div id="content_right">
                    <%
                        ...
                        String query = "select count(sponsor_id) from sponsor ";
                    ...
                    %>
                    <form action="sponsor_register_process.jsp" method="post" id="sform">
                        <center>
                            <h2>Sponsor Registration</h2>
                            <br><br><br>
                                        <table>
                                            <tr>
                                                <td align="right">Sponsor ID:</td><td> <input type="text" align="left" value="SPONSOR<%=maxID%>" name="sid"/></td>
                                            </tr>
                                            <tr></tr> <tr></tr> <tr></tr>
                                            <tr>
                                                <td align="right">Sponsor Name:</td><td> <input type="text" align="left" name="sname"/></td>
                                            </tr>
                                            <tr></tr> <tr></tr> <tr></tr>
                                            <tr>
                                            ...
                                            <tr></tr> <tr></tr> <tr></tr>
                                            <tr>
                                                <td align="right">Occupation/Organization : </td><td> <input type="text" align="left" name="occu"/></td>
                                            </tr>
                                            <tr></tr> <tr></tr> <tr></tr>
                                            <tr>
                                        ...
                                        <br>
                                       <font size = '4' >     Already Registered ? <a href="sponsor_login.jsp"><u> Login Here</u></a></font>
                                        </center>
                                        </form>       
                                        <div class="cleaner">&nbsp;</div>
                                        </div>                    
