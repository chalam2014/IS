 ...
 This annual event builds upon the great service performed throughout the year by the Villanova community and exists as a unique way to put its Augustinian ideals into action.</p>
        ...
        <div id="templatemo_content_wrapper">
            <div id="templatemo_content">
                    <div id="center">
                    <center><h1>Sponsors List </h1></center>                      
                        <%
                            try {
                                Connection con = com.DB.DBConnection.getCon();
                                PreparedStatement ps = con.prepareStatement("select sponsor_id,sponsor_name,email,occupation,address,cno from sponsor");
                                ResultSet rs = ps.executeQuery();
                        %>
  <center>                     
                        <br><br>
                                <table class = "main" border="3">
                                    <tr>
                                        <td><h4>Sponsor ID</h4></td>
